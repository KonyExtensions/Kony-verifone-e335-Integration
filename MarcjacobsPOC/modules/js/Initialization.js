...
var callbacksObj = {onactive:null,oninactive:null,onbackground:appbackground,onforeground:appforeground,onappterminate:appbackground,retainSpaceOnHide:true};
...
if("frmSaleTransaction"== currentForm)
	barcode.scan(callbackBarcodeScanData);
if("frmTender"== currentForm)
